                        ...
                        <table class="shop_table cart">
                            ...
                            <tr class="cart_item">
                                ...
                                <td class="product-quantity">
                                    ...
                                    <div class="quantity">
                                        <a href="{{ route('cart.dec', ['id'=>$product->rowId, 'qty'=>$product->qty]) }}" class="quantity-minus">-</a>
                                        <input title="Qty" class="email input-text qty text" type="text" placeholder="1" readonly value="{{$product->qty}}">
                                        <a href="{{ route('cart.inc', ['id'=>$product->rowId, 'qty'=>$product->qty]) }}" class="quantity-plus">+</a>
                                    </div>
